<?php
  ...
  if($month > 1){
    $previoustMonthLink = "<a href='calendario.php?month=".($month-1)."&year=".$year."'>&lt;&lt;Mes Anterior</a>";
  }else{
    $previoustMonthLink = "<a href='calendario.php?month=".(12)."&year=".($year-1)."'>&lt;&lt;Mes Anterior</a>";
  }

  //Enlace al siguiente mes
  if($month < 12){
    $nextMonthLink = "<a href='calendario.php?month=".($month+1)."&year=".$year."'>Siguiente Mes&gt;&gt;</a>";
  }else{
    $nextMonthLink = "<a href='calendario.php?month=".(1)."&year=".($year+1)."'>Siguiente Mes&gt;&gt;</a>";
  }
