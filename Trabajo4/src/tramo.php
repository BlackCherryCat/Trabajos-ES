...
<?php 
  ...
  function getOccupation($hora, $dia, $db, $index, &$plazas){
    ...
    if(mysqli_num_rows($result) == 0){
      $cadena .="<td><div class='wrapper'><label for='tramo$index'><div class='nuevo'>&#10133;<br>Añadir Tramo</div><div class='remove-hover'>&#x2716;<br>Eliminar Tramo</div></label><div class='free'>Asientos Libres<br>100</div></div></td>";
      $plazas["tramo$index"] = 100;
    }else{
